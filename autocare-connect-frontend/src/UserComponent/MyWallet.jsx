...
const MyWallet = () => {
  ...
  const retrieveMyWallet = async () => {
    const response = await axios.get(
      "http://13.60.229.97:8080/api/user/fetch/user-id?userId=" + user.id
    );
  ...
  const addMoneyInWallet = (e) => {
    fetch("http://13.60.229.97:8080/api/user/update/wallet", {
      method: "PUT",
      headers: {
        ...
        result.json().then((res) => {
          if (res.success) {
            ...
            options.handler = function (response) {
              ...
              fetch("http://13.60.229.97:8080/api/user/razorpPay/response", {
                method: "PUT",
                headers: {
                  Accept: "application/json",
                  "Content-Type": "application/json",
